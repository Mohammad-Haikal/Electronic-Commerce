                            ...
                            <tr>
                                ...
                                <td>
                                    <form style="width: fit-content;" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <button name="deleteFeedback" onclick="return confirm('Are you sure to delete this order?')" type="submit" class="link-danger bg-transparent border-0">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach ?>
